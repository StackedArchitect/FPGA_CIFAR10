`timescale 1ns / 1ps
//============================================================================
// Synthesis wrapper — CIFAR-10 CNN (TTQ + BatchNorm + DAAP Threshold)
//
// Provides file path parameters for all TTQ weight/BN/data/threshold files.
// The DUT (cnn2d_top_cifar_ttq) manages all BRAMs internally.
//
// PARALLEL_CH = 4
// Weight ROMs: 2-bit distributed (no BRAM consumed by weights)
//
...
module cnn2d_synth_top_cifar_ttq #(
    ...
    // ================================================================
    localparam CONV1_ACT_THRESH_FILE = "conv1_act_thresh.mem";
    localparam CONV2_ACT_THRESH_FILE = "conv2_act_thresh.mem";
    localparam CONV3_ACT_THRESH_FILE = "conv3_act_thresh.mem";
    localparam CONV4_ACT_THRESH_FILE = "conv4_act_thresh.mem";
    localparam FC1_ACT_THRESH_FILE   = "fc1_act_thresh.mem";
    localparam FC2_ACT_THRESH_FILE   = "fc2_act_thresh.mem";
    ...
    // ================================================================
    //  DUT — TTQ weights, BN, thresholds, and input data loaded internally
    // ================================================================
    cnn2d_top_cifar_ttq #(
        .INPUT_H          (INPUT_H),
        .INPUT_W          (INPUT_W),
        ...
        // DAAP activation threshold files
        .CONV1_ACT_THRESH_FILE(CONV1_ACT_THRESH_FILE),
        .CONV2_ACT_THRESH_FILE(CONV2_ACT_THRESH_FILE),
        .CONV3_ACT_THRESH_FILE(CONV3_ACT_THRESH_FILE),
        .CONV4_ACT_THRESH_FILE(CONV4_ACT_THRESH_FILE),
        .FC1_ACT_THRESH_FILE  (FC1_ACT_THRESH_FILE),
        .FC2_ACT_THRESH_FILE  (FC2_ACT_THRESH_FILE),
