`timescale 1ns / 1ps
//============================================================================
// Synthesis wrapper — CIFAR-10 CNN (TTQ + BatchNorm)
//
// Provides file path parameters for all TTQ weight/BN/data files.
...
module cnn2d_synth_top_cifar_ttq #(
    ...
    // ================================================================
    //  DUT — TTQ weights, BN, and input data loaded internally
    // ================================================================
    cnn2d_top_cifar_ttq #(
        .INPUT_H          (INPUT_H),
        .INPUT_W          (INPUT_W),
